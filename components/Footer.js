                        ...
                        <div className="row">
                                ...
                                <div className="widget about-widget">
                                    ...
                                    <div className="widget social-widget">
                                        <ul>
                                            ...
                                            <li><Link href={company.telegramUrl} target="_blank" rel="noopener noreferrer" aria-label="Message Oru Studio on Telegram"><i className="ti-comment"></i></Link></li>
                            ...
                            <div className="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div className="widget subscribe">
                                    ...
                                    <p>
                                    Shopify guides, ecommerce tutorials, App Store case studies, and practical implementation notes from Oru Studio.</p>
                                    <form action="#">
